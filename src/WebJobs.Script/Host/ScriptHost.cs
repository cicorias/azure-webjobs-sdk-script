...
namespace Microsoft.Azure.WebJobs.Script
{
    public class ScriptHost : JobHost
    {
        ...
        protected virtual void Initialize()
        {
            ...
            foreach (var provider in ScriptConfig.BindingProviders)
            {
                provider.Initialize();
            }
        ...
        private static Collection<ScriptBindingProvider> LoadBindingProviders(JobHostConfiguration hostConfig, JObject hostMetadata, TraceWriter traceWriter)
        {
            ...
            {
                new WebJobsCoreScriptBindingProvider(hostConfig, hostMetadata, traceWriter),
                new ServiceBusScriptBindingProvider(hostConfig, hostMetadata, traceWriter),
                new CoreExtensionsScriptBindingProvider(hostConfig, hostMetadata, traceWriter),
                new ApiHubScriptBindingProvider(hostConfig, hostMetadata, traceWriter),
                new DocumentDBScriptBindingProvider(hostConfig, hostMetadata, traceWriter),
                new MobileAppsScriptBindingProvider(hostConfig, hostMetadata, traceWriter),
                new NotificationHubScriptBindingProvider(hostConfig, hostMetadata, traceWriter)
            };

            // TODO: Dynamically discover and load any additional extensions
